...
def get_tf_idf(data_path):
    with open("./20news-bydate/words_idfs.txt") as f:
        words_idfs = [
            (line.split("<fff>")[0], float(line.split("<fff>")[1]))
...
def generate_vocabulary(data_path):
    ...
    words_idfs = [
        (word, compute_idf(document_freg, corpus_size))
...
def gather_20newsgroups_data(path="./20news-bydate/"):
    ...
    with open("./20news-bydate/stop_word.txt") as f:
...
gather_20newsgroups_data("./20news-bydate/")
